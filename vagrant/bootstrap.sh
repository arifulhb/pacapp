...
sudo apt-get install curl php5-curl php5-gd php5-mcrypt php5-mysql php5-memcached php5-memcache php5-sqlite php5-json php5-xmlrpc php5-geoip -y > /dev/null
