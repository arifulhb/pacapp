<div class="row">
    <div class="col-sm-12">
            ...
            <div class="panel-body text-center">
                <h3>Membership Receipt</h3>
                 <dl>
                    ...
                    <dd>$<?php echo number_format(($_record[0]['cust_balance'])+($_record[0]['tran_value']),'2','.',',');?></dd>
                    
                    <dt>Amount Deducted</dt>
                    <dd>$<?php echo number_format($_record[0]['tran_value'],'2','.',',');?></dd>

                    <dt>New Balance</dt>
                    <dd>$<?php echo number_format($_record[0]['cust_balance'],'2','.',',');?></dd>                    
        ...
        <button type="submit" class="btn btn-lg btn-primary btn-block btn-print noprint">Print</button>
        <a href="<?php echo base_url();?>" class="btn btn-lg btn-default btn-block noprint">Done</a></div>
</div>
