<section class="panel scancard">
    ...
    <div class="panel-body">   
        ...
        $_not_found          = $this->session->flashdata('_not_found');
        $_id                = $this->session->flashdata('_id');
        if($_status==TRUE){
         ...
         if($_not_found==TRUE){ 
            ...
            <div class="alert alert-warning fade in">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <strong>Sorry!</strong> Customer <strong>CARD ID</strong> or <strong>ID Number</strong> Does not match.
              </div> 
            <?php
        }//end if
        ...
        <form role="form" method="POST" class="keypad"
              action="<?php echo base_url().'customer/getExistingByCard';?>">
