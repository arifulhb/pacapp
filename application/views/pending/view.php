            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-xs-8">
                            <label class="control-label"><?php echo $_record[0]['num_of_months'];?></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputNewBalance" class="col-lg-4 col-xs-4 control-label">New Balance </label>
                        <div class="col-lg-8 col-xs-8">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8 col-xs-8">
                    <label class="control-label"><?php                     
                        if($_record[0]['status']==0){
                            echo '<span  class="label label-warning">Pending</label>';
                        }elseif($_record[0]['status']==1){
                            echo '<span  class="label label-success">Approved</label>';
                        }elseif($_record[0]['status']==2){
