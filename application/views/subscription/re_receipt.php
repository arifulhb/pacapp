    ...
    <div class="col-sm-12">
        <section class="panel receipt print">
            <header class="panel-heading text-center">
                Prime Auto Care                
                <small>Outlet: <?php echo $_subs['ol_name'];?></small>
                <small>By: <?php echo $_subs['user_name'];?></small>
            </header>
            <div class="panel-body text-center">                
                ...
                <dl>
                    ...
                    <dd><span>Old Balance:</span> <?php echo number_format($_subs['old_balance'],2,'.',',');?></dd>
                    <dd><span>Today's Redemption:</span> <?php echo $_subs['redemption'];?></dd>
        ...
        <a href="<?php echo base_url().'home/past_receipt';?>" class="btn btn-lg btn-default btn-block noprint">Done</a>                    
    </div>
</div>
